...
* ⚙️ Hands-on with **DevOps, CI/CD, Containers & Kubernetes**
* 📊 Exploring **Data Engineering & Big Data**
* ⚡ Working with **Kafka & distributed streaming systems**
* 🗄️ Exploring **Ceph & distributed storage**
...
<p>
  <img src="https://img.shields.io/badge/Zeek-1E4D6B?style=for-the-badge&logoColor=white" />
...
* ⚙️ **IBM WebSphere Application Server Network Deployment 8.5.5**
...
Exploring scalable and fault-tolerant streaming architectures using **Apache Kafka and Apache Spark**.

### 🗄️ Distributed Storage

Working with **Ceph** and cloud-native storage architectures for scalable and highly available systems.

### 📡 Network Traffic Analytics

Working with architectures involving **PCAP, Kafka, Ceph, Zeek, Suricata, Elasticsearch, and IP intelligence**.
